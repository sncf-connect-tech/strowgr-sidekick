...
func main() {
	...
	go func() {
		defer wg.Done()
		wg.Add(1)
		consumer, _ := nsq.NewConsumer(fmt.Sprintf("delete_requested_%s", properties.ClusterId), fmt.Sprintf("%s#ephemeral", properties.NodeId()), config)
	...
	go func() {
		defer wg.Done()
		wg.Add(1)
		consumer, _ := nsq.NewConsumer(fmt.Sprintf("commit_requested_%s", properties.ClusterId), fmt.Sprintf("%s#ephemeral", properties.NodeId()), config)
	...
	go func() {
		defer wg.Done()
		wg.Add(1)
		consumer, _ := nsq.NewConsumer(fmt.Sprintf("commit_slave_completed_%s", properties.ClusterId), fmt.Sprintf("%s#ephemeral", properties.NodeId()), config)
	...
	go func() {
		defer wg.Done()
		wg.Add(1)
		consumer, _ := nsq.NewConsumer(fmt.Sprintf("commit_completed_%s", properties.ClusterId), fmt.Sprintf("%s#ephemeral", properties.NodeId()), config)
